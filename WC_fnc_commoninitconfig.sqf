	...
	wcteamspeak = "Enjoy yourself but play fair, no griefing and exercise comms discipline.";

	// put names of team members in array
	// will give same rights as the admin
	// uncomment line below
	wcteammembers = ["code34", "slerbal"];
	...
	wcspecialforces = ["Ins_Commander", "Ins_Soldier_GL", "Ins_Soldier_MG", "Ins_Soldier_Sab", "Ins_Soldier_Sniper"];
	...
	wcchangeclothescivil = ["ibr_paramedic", "ibr_lingorman1", "ibr_lingorman2", "ibr_lingorman3", "ibr_lingorman4", "ibr_lingorman5", "ibr_lingorman6", "ibr_lingorman7"];
	...
	wcvehicleslistathq = ["ATV_US_EP1","BAF_Jackal2_GMG_W","HMMWV_M998A2_SOV_DES_EP1"];
	...
	if(wcautoloadtroops == 1) then {
		...
		wceastside = [["ibr_arl_faction","ibr_drg_faction","INS"],[["ibr_arl_faction", "ibr_arl_officer"],["ibr_arl_faction", "ibr_arl_rif"],["ibr_arl_faction", "ibr_arl_rif2"],["ibr_arl_faction", "ibr_arl_mg"],["ibr_arl_faction", "ibr_arl_ar"],["ibr_arl_faction","ibr_arl_aa"],["ibr_arl_faction", "ibr_arl_at"],["ibr_arl_faction", "ibr_arl_sniper"],["ibr_arl_faction", "ibr_arl_sab"],["ibr_arl_faction", "ibr_arl_medic"],["ibr_drg_faction", "ibr_drg_officer"],["ibr_drg_faction", "ibr_drg_at"],["ibr_drg_faction", "ibr_drg_man1"],["ibr_drg_faction", "ibr_drg_man2"],["ibr_drg_faction", "ibr_drg_man3"],["ibr_drg_faction", "ibr_drg_man4"],["ibr_drg_faction", "ibr_drg_man5"],["ibr_drg_faction", "ibr_drg_man6"],["ibr_drg_faction", "ibr_drg_man7"],["ibr_drg_faction", "ibr_drg_eric"],["BIS_TK","TK_Aziz_EP1"],["BIS_TK","TK_Commander_EP1"],["INS","Ins_Commander"],["INS","Ins_Soldier_1"],["INS","Ins_Soldier_2"],["INS","Ins_Soldier_AA"],["INS","Ins_Soldier_AR"],["INS","Ins_Soldier_AT"],["INS","Ins_Soldier_CO"],["INS","Ins_Soldier_GL"],["INS","Ins_Soldier_MG"],["INS","Ins_Soldier_Medic"],["INS","Ins_Soldier_Pilot"],["INS","Ins_Soldier_Sab"],["INS","Ins_Soldier_Sapper"],["INS","Ins_Soldier_Sniper"]]];
	...
	if(wcautoloadvehicles == 1) then {
		...
		wcvehicleslistE = ["ibr_offroad_dshkm_arl", "ibr_offroad_spg9_arl", "LIN_Pinz_arl1", "LIN_Pinz_arl2", "zsu57_ARL", "BRDM2_ATGM_INS", "BRDM2_INS", "BTR90", "GAZ_Vodnik", "GAZ_Vodnik_HMG", "GRAD_INS", "Kamaz", "KamazOpen", "KamazReammo", "KamazRefuel", "KamazRepair", "Offroad_DSHKM_INS", "Pickup_PK_INS", "UAZ_AGS30_INS", "UAZ_INS", "UAZ_MG_INS", "UAZ_RU", "UAZ_SPG9_INS", "UralOpen_INS", "UralReammo_INS", "UralRefuel_INS", "UralRepair_INS", "Ural_INS", "Ural_ZU23_INS", "2S6M_Tunguska", "BMP2_INS", "T34", "T72_INS", "ZSU_INS"];		
